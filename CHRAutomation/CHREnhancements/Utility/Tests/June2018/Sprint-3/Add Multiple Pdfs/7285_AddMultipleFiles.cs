...
namespace CHREnhancements.Tests.June2018.Sprint_3.Add_Multiple_Pdfs
{
    ...
    public class _7285_AddMultipleFiles : Base
    {
        ...
        public void AddMutipleFiles(string browsername)
        {
            ...
            try
            {
                ...
                action.GoToURL("http://ii4.uat.brandmuscle.net/trainingguides.aspx");
                loginpage.LoginToApplication(Testdata.username, Testdata.password);
               // viewfiles.VerifyFiles();
                //viewfiles.ClickOnPdfLink();
            }
            catch (Exception e)
            {
