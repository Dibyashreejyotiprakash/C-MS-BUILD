...
namespace CHREnhancements.Tests.June2018.Sprint_1.WorkCenter
{
    ...
    public class _6209_Projects : Base
    {
        Interactions action;
        LoginPage loginpage;
        HomePage homepage;
        ...
        public void VerifyMyProjects(string browsername)
        {
            ...
            try
            {
                ...
                projectspage.VerifyListOfTemplates();
                projectspage.FilterByDeisgnName();
                projectspage.VerifySortByDesignName();
                Driver.Quit();
            }
            catch (Exception e)
            {
                Console.WriteLine("Verify projects failed due to " + e);
                Assert.Fail();
            }
        }
    }
