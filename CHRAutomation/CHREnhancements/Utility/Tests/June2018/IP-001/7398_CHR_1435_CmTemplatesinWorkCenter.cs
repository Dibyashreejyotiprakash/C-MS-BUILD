...
namespace CHREnhancements.Tests.June2018.IP_001
{
    [TestFixture]
    [Parallelizable]
    public class _7398_CHR_1435_CmTemplatesinWorkCenter : Base
    {
        Interactions action;
        LoginPage loginpage;
        HomePage homepage;
        ...
        public void CmTemplateWorkCenter(string browsername)
        {
            ...
            {
                Console.WriteLine("Coupon Maker template workcenter failed due to " + e);
                Assert.Fail();
            }
        }
    }
