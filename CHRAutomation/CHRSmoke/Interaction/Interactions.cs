...
namespace CHRSmoke.Interaction
{
    public class Interactions 
    {
        IWebDriver Driver;
        // public static string USER_TYPE = "GENERIC";
        ...
        public void MouseOverOnElement(IWebElement element)
        {
           // IWebElement elementToHover = Driver.FindElement(element);
        ...
        public void MouseHoverAndHoverClick(By by)
        {
        ...
        public void TypeClear(By by, string value,IWebDriver Driver)
        {
            var element = Driver.FindElement(by);
            element.Clear();
            element.SendKeys(value);
        ...
        public void HoverByJavaScript(IWebElement element)
        {
            string javaScript = "var evObj = document.createEvent('MouseEvents');" +
                    "evObj.initMouseEvent(\"mouseover\",true, false, window, 0, 0, 0, 0, 0, false, false, false, false, 0, null);" +
                    "arguments[0].dispatchEvent(evObj);";
